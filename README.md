...
To submit the homework, please upload your solutions as a PDF (`hw3.pdf`) *and* accompanying code (`hw3.dfy` plus any corresponding helper files) to Gradescope. You are encouraged (but not required) to write your solutions in LaTeX; if you would like to edit `hw3.tex` directly, please remove or comment out the problem statements and include only your solutions. The homework should be typed.
