...
- Please ensure that your code is called `hw3.dfy` and your file is called `hw3.pdf` to get credit.

- You are encouraged (but not required) to write your solutions in LaTeX; if you would like to edit `hw3.tex` directly, please remove or comment out the problem statements and include only your solutions. The homework should be typed.
